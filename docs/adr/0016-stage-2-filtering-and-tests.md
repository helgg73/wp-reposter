...
- **Date:** 2026-09-15
- **Updated:** 2026-09-16
- **Related:** ADR 0004 (WP REST API), ADR 0005 (asyncio), ADR 0009 (JSON state), ADR 0012 (модели), ADR 0013 (синхронный парсер), ADR 0015 (план миграции), ADR 0020 (структура модулей), ADR 0025 (Подготовка к автономному запуску через systemd)
