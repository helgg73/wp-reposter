...
- **Этап 2b:** 🟡 В работе (автономный запуск: systemd, логирование, отказоустойчивость)
...
| 0025 | Подготовка к автономному запуску через systemd | Accepted |
...
- [0025-autonomous-run-systemd.md](doc/adr/0025-autonomous-run-systemd.md) — детали Этапа 2b (автономный запуск)
